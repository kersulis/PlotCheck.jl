...
@testset "check_plot" begin
    ...
    plot!(p; xlabel="")
    @test_throws AssertionError check_plot(p)
    plot!(p; xlabel="xlabel", ylabel="")
    @test_throws AssertionError check_plot(p)

    # gives warning if no title
    plot!(p, ylabel="ylabel", title="")
    @test_logs (:warn, "Subplot is missing a title.") check_plot(p)
    plot!(p; title="title")
    @test_nowarn check_plot(p)
...
@testset "compare_plots single series" begin
    ...
    @test_logs (:warn, "Subplot 1 title does not match reference.") compare_plots(submission, reference)
    ...
    @test_logs (:warn, "Subplot 1 xlabel does not match reference.") compare_plots(submission, reference)

    submission = plot([1, 2, 3], [3, 2, 1]; xlabel="xlabel", ylabel="wrong", title="title", color=:blue, label="Series 1")

    @test_logs (:warn, "Subplot 1 ylabel does not match reference.") compare_plots(submission, reference)
    ...
    @test_logs (:warn, "Label for series 'wrong' does not match reference label 'Series 1'.") compare_plots(submission, reference)
end
...
@testset "compare_plots multiple series" begin
    ...
    @test_throws AssertionError compare_plots(submission, reference)
    ...
    @test_logs (:warn, "Marker shape for series 'Series 2' does not match reference shape :octagon.") compare_plots(submission, reference)
